rem
rem	Script:		snap_redo.sql
rem	Author:		Jonathan Lewis
rem	Dated:		March 2001
rem	Purpose:	Package to get snapshot start and delta of redo from v$sysstat
rem
rem	Notes
...
rem		execute snap_redo.start_snap
rem		-- do something
rem		execute snap_redo.end_snap
rem

create or replace package snap_redo as
	procedure start_snap;
	procedure end_snap;
end;
/

create or replace package body snap_redo as
...
begin
	...
	dbms_output.put_line('System REDO stats - ' ||
...
drop public synonym snap_redo;
create public synonym snap_redo for snap_redo;
grant execute on snap_redo to public;
