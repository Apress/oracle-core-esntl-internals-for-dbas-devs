rem
rem	July 2011
rem	core_dc_activity_04.sql
rem
rem	Explicit parse calls, and the switch from the
rem	pl/sql cursor cache to searching the library cache
rem	after changing session_cached_cursors
rem
